const topicsData = [
  ...
  },
  {
    ...
    links: [
      ...
      { platform: 'Refactoring Guru', url: 'https://refactoring.guru/design-patterns' },
      { platform: 'Medium - OOP', url: 'https://medium.com/tag/oop' },
    ],
  },
  {
    id: 'solid',
    ...
    links: [
      ...
      { platform: 'Dev.to SOLID', url: 'https://dev.to/search?q=SOLID' },
      { platform: 'Baeldung SOLID', url: 'https://www.baeldung.com/solid-principles' },
    ],
  },
];
